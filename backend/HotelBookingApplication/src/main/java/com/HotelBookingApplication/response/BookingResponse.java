...
public class BookingResponse {
	...
	public String toString() {
		return "BookingResponse [id=" + id + ", checkInDate=" + checkInDate + ", checkOutDate=" + checkOutDate
				+ ", guestName=" + guestName + ", guestEmail=" + guestEmail + ", numOfAdults=" + numOfAdults
				+ ", numOfChildren=" + numOfChildren + ", totalNumOfGuests=" + totalNumOfGuests
